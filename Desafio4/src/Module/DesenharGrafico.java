...
public class DesenharGrafico {
	 ...
	 public void Desenho(String saida, int angulo) throws IOException {
		 Pilha pilha = new Pilha();
		 FileWriter arqW = new FileWriter("grafico.html");
		 ...
		 {				
			if(Character.isLetter(saida.charAt(m))& saida.charAt(m)!='X')
			{
				...
				gravarArq.printf("<line x1=\""+x1+"\" y1=\""+y1+"\" x2=\""+x2+"\" y2=\""+y2+"\" stroke-width=\"2\" stroke=\"red\"/>\r\n");
				x1=x2;
				y1=y2;
			}
			...
			{
				pilha.empilhar(String.valueOf(AngNow+","+x2+","+y2));
			}
			else if(saida.charAt(m)==']')
			{
     ...
     gravarArq.printf("Sorry, your browser does not support inline SVG.\r\n"
     		+ "</svg>\r\n"
     		+ "\r\n"
     		+ "</body>\r\n"
     		+ "</html>");
